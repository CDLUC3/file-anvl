# This Makefile is for the File::ANVL extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/File/ANVL.pm]
#     AUTHOR => q[John A. Kunze <jak@ucop.edu>]
#     EXE_FILES => [q[anvl]]
#     LICENSE => q[BSD]
#     NAME => q[File::ANVL]
#     PL_FILES => {  }
#     PM => { lib/File/ANVL.pm=>q[blib/lib/File/ANVL.pm], lib/File/OM.pm=>q[blib/lib/File/OM.pm] }
#     PREREQ_PM => { Text::Wrap=>q[0] }
#     VERSION_FROM => q[VERSION]
#     clean => { FILES=>q[File-ANVL-*] }
...
TO_INST_PM = lib/File/ANVL.pm \
	lib/File/OM.pm

PM_TO_BLIB = lib/File/ANVL.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN1EXT) --perm_rw=$(PERM_RW) \
	  anvl $(INST_MAN1DIR)/anvl.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/File/ANVL.pm $(INST_MAN3DIR)/File::ANVL.$(MAN3EXT) \
	  lib/File/OM.pm $(INST_MAN3DIR)/File::OM.$(MAN3EXT) 
...
$(INST_SCRIPT)/anvl : anvl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/anvl
	$(CP) anvl $(INST_SCRIPT)/anvl
	$(FIXIN) $(INST_SCRIPT)/anvl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/anvl
